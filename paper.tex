...
\begin{figure*}
  \centering
    ...
    \begin{subfigure}{0.32\textwidth}
      ...
      \caption{Viscous and Ohmic heating}
      \label{fig:heating-4}
    \end{subfigure}
...
\rev{At approximately $t\approx 27$} the tube becomes unstable \rev{to
the flute instability} \rev{as observed from the linear growth phase
  of the kinetic energy shown in Figure
  \ref{fig:kink_str8_ke-4}(b)}. The the plasma begins to  bulge out
diagonally from the high-pressure core displaying an azimuthal
wavenumber $m=4$ as seen in Figure~\ref{fig:swi-4_pressure_13}. As  the
...
\todo{change u_r to u_x in kink perturbation plot}
...
\todo{put Q_... in angle brackets and explain what it means in caption}
...
RRRRRR: the fluting perturbation is observable so we can measure
e.g. wavenumbers but there is no appreciable growth so cannot measure
e.g. growth rate}  
\centering
\begin{tabular}{ccccc}
...
particularly in the more ideal case where $\eta=10^{-4}$. \todo{explain discrepancy} The location of the
